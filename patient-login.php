...
if (isset($_POST['submit'])) {
  ...
  $select_user = $conn->prepare("SELECT * FROM `patients` WHERE email = ? AND pass = ? LIMIT 1");
...
<section id="appointment" class="appointment section-bg">
    <div  class="container text-center">
        ...
        <form style="width: 30%; margin: 0 auto;"  method="post" role="form" class="php-email-form">
            ...
            <div class="mt-2"><span>Don't have an Account</span> <a href="patient-register.php">Register</a></div>
        </form>
